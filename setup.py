...
setup(
  name = 'tt',         # How you named your package folder (MyLib)
  packages = ['tt'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/AbhishekPailwan/abhitry/archive/v_01.tar.gz',    # I explain this later on
